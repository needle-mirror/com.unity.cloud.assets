...
namespace Unity.Cloud.Assets
{
    ...
    partial interface IAssetDataSource
    {
        ...
        IAsyncEnumerable<FileDownloadUrl> GetAssetDownloadUrlsAsync(AssetDescriptor assetDescriptor, DatasetId[] datasetIds, Range range, CancellationToken cancellationToken);
