...
namespace Unity.Cloud.Assets
{
    ...
    interface IAssetCollectionDataSource
    {
        ...
        Task UpdateCollectionAsync(IProject project, IAssetCollection assetCollection, CancellationToken token);
        ...
        /// <param name="token">The cancellation token</param>
        /// <returns>A task with no result.</returns>
        Task DeleteCollectionAsync(IProject project, CollectionPath collectionPath, CancellationToken token);
        ...
        /// <param name="token">The cancellation token</param>
        /// <returns></returns>
        Task<string> InsertAssetsToCollectionAsync(IProject project, CollectionPath collectionPath, IEnumerable<IAsset> assets, CancellationToken token);
        ...
        /// <param name="token">The cancellation token</param>
        /// <returns></returns>
        Task<string> RemoveAssetsFromCollectionAsync(IProject project, CollectionPath collectionPath, IEnumerable<IAsset> assets, CancellationToken token);
        ...
        /// <param name="token">The cancellation token</param>
        /// <returns></returns>
        Task<string> MoveCollectionToNewPathAsync(IProject project, CollectionPath collectionPath, CollectionPath newCollectionPath, CancellationToken token);
    }
}
