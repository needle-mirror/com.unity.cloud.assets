...
namespace Unity.Cloud.Assets
{
    ...
    public interface IAssetCollectionManager
    {
        ...
        /// </summary>
        /// <param name="project">The project in which the collections reside. </param>
        ...
        /// </summary>
        /// <param name="project">The project in which the collection resides. </param>
        ...
        /// </summary>
        /// <param name="project">The project in which the collection will reside. </param>
