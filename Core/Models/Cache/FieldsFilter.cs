...
namespace Unity.Cloud.Assets
{
    ...
    class FieldsFilter
    {
        ...
        public static FieldsFilter DefaultDatasetIncludes => new()
        {
            ...
            DatasetFields = DatasetFields.description | DatasetFields.authoring | DatasetFields.filesOrder | DatasetFields.primaryType | DatasetFields.workflowName | DatasetFields.vcsMappingId,
            FileFields = FileFields.none,
        };
