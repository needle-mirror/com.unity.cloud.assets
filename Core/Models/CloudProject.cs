...
namespace Unity.Cloud.Assets
{
    ...
    class CloudProject : IProject
    {
        ...
        internal CloudProject(string id, string name = default, Dictionary<string, IDeserializable> metadata = null, string[] storageIds = null, string status = nameof(IProject.ProjectStatus.unknown), int? userCount = default)
        {
            m_Id = id;
            m_Name = name;
            m_Metadata = metadata;
